...
Private Declare Function Sound Lib "winmm.dll" Alias "PlaySoundA" (ByVal lpszName As String, ByVal hModule As Long, ByVal dwFlags As Long) As Long
...
Private Sub tmrSlide_Timer()
    ...
    Select Case CntDelay
      Case 40
        OpenClose = toOpen
        Sound "SystemStart", 0&, SoundFlags
      Case 41
        CntDelay = 40
    End Select
    Select Case Rounds
...
':) Ulli's VB Code Formatter V2.23.17 (2008-Jan-29 14:15)  Decl: 74  Code: 336  Total: 410 Lines
':) CommentOnly: 16 (3,9%)  Commented: 26 (6,3%)  Empty: 101 (24,6%)  Max Logic Depth: 4
